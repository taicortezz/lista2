...
<s>B) O código avalia a expressão booleana, imprime o resultado `true`, calcula a soma dos números de 1 a 5 e imprime o resultado no console. (correta)</s>
...
<s>B) A saída de calcularOrcamento() seria: 'Seu saldo é negativo de -1050.' e a de calcularOrcamento2() seria: 'Seu saldo é negativo de -100.' (correta) </s>
...
<s>D) O código verifica se o número é par, se é divisível por 3 ou se é ímpar. Se for par, exibe a mensagem "O número é par!". Se for divisível por 3 (e não for par), exibe a mensagem "O número é divisível por 3!". Se for ímpar (e não for divisível por 3), exibe a mensagem "O número é ímpar e não é divisível por 3!". (correta)</s>
...
![Uma imagem](assets/image.png)
 ...
 O pseudocódigo do fluxograma ficaria assim:
...
Classe Retangulo com herança em classe FormaGeometrica{

construir atributos (cor, altura, base)

herdou de FormasGeometricas: cor
...
método CalcularAreaRetangulo(){
    ...
    imprima('retangulo tem area =' + area)

}

Classe Circulo com herança em classe FormaGeometrica{

construir atributos (cor, raio)
